...
/**
 *  Tests the proj0.Planet constructor.
 */
public class TestPlanetConstructor {

    /**
     *  Tests the proj0.Planet constructor to make sure it's working correctly.
     */
    ...
    /**
     *  Checks proj0.Planet constructors to make sure they are setting instance
     *  variables correctly.
     */
    private static void checkPlanetConstructor() {
        System.out.println("Checking proj0.Planet constructor...");
